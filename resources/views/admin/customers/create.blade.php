...
@section('content')
    <div class="max-w-5xl mx-auto py-6">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div
                class="bg-gradient-to-r from-agri-primary to-green-600 px-8 py-6 flex justify-between items-center relative overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex items-center gap-4">
                    <div
                        class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center text-white shadow-inner">
            ...
            <form action="{{ route('admin.customers.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-10">
                    <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                        <div
                            class="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center shadow-sm">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 mb-8 items-start">
                        <div class="shrink-0 mx-auto md:mx-0">
                            <div
                                class="w-32 h-32 rounded-full bg-gray-100 border-4 border-white shadow-md flex items-center justify-center overflow-hidden relative group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2 ml-1">ประเภทลูกค้า <span
                                    class="text-red-500">*</span></label>
                            <div class="relative">
                                <select name="customer_type"
                                    class="block w-full pl-11 pr-10 py-3 border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-agri-primary/20 focus:border-agri-primary text-sm transition duration-200 appearance-none bg-white">
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2 ml-1">ชื่อลูกค้า / ชื่อฟาร์ม <span
                                    class="text-red-500">*</span></label>
                            <div class="relative">
                        ...
                        <div>
                            <label
                                class="block text-sm font-semibold text-gray-700 mb-2 ml-1">เลขประจำตัวผู้เสียภาษี</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2 ml-1">เบอร์โทรศัพท์ <span
                                    class="text-red-500">*</span></label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-gray-400 mt-1 ml-1">* ใช้เป็น Username และ Password เริ่มต้น (4 ตัวท้าย)
                            </p>
                        </div>

                        <div class="md:col-span-2 p-5 bg-green-50/50 rounded-2xl border border-green-100">
                            <label class="block text-sm font-bold text-green-800 mb-2 ml-1">พื้นที่เพาะปลูกรวมของลูกค้า
                                (ไร่)</label>
                            <div class="relative w-full md:w-1/2">
                                <input type="number" name="farm_area" step="0.1" min="0"
                                    value="{{ old('farm_area', 0) }}"
                                    class="block w-full pl-11 pr-12 py-3 border-green-200 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500/20 focus:border-green-500 text-sm font-medium transition duration-200"
                                    placeholder="จำนวนพื้นที่ (ไร่)">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div class="mb-8">
                    <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                        <div
                            class="w-10 h-10 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center shadow-sm">
                            <i class="fa-solid fa-location-dot text-lg"></i>
                        </div>
                        <div>
                            <h3 class="text-gray-800 font-bold text-lg">ข้อมูลที่อยู่ และ พิกัดแผนที่</h3>
                            <p class="text-gray-400 text-xs">ระบุที่อยู่และละติจูด/ลองจิจูด เพื่อให้พนักงานเดินทางง่ายขึ้น
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2 ml-1">ที่อยู่ (เลขที่, หมู่, ถนน)
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="amphure" name="district" value="{{ old('district') }}"
                                    class="block w-full pl-11 pr-4 py-3 border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-agri-primary/20 focus:border-agri-primary text-sm transition duration-200">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="zipcode" name="postal_code" value="{{ old('postal_code') }}"
                                    class="block w-full pl-11 pr-4 py-3 border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-agri-primary/20 focus:border-agri-primary text-sm transition duration-200">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        ...
                        {{-- ✅ สถานที่ปฏิบัติงาน (แยกจากที่อยู่ลูกค้า) --}}
                        <div class="md:col-span-2 mt-2 p-5 bg-blue-50/60 rounded-2xl border border-blue-100">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
                                <div>
                                    <label class="block text-sm font-bold text-blue-800 ml-1">สถานที่ปฏิบัติงาน (แยกจากที่อยู่ลูกค้า)</label>
                                    <p class="text-[11px] text-blue-700/80 ml-1 mt-0.5">แนะนำให้แปะลิงก์ Google Maps เพื่อให้พนักงานกดนำทางได้ทันที</p>
                                </div>
                                <a href="https://www.google.com/maps" target="_blank"
                                    class="text-xs font-bold bg-white text-blue-600 border border-blue-200 px-3 py-1.5 rounded-lg hover:bg-blue-600 hover:text-white transition shadow-sm inline-flex items-center gap-1">
                                    <i class="fa-solid fa-share-nodes"></i> เปิด Google Maps
                                </a>
                            </div>

                            <div class="mb-4">
                                <label class="block text-xs font-semibold text-blue-700 mb-1">ลิงก์หน้างาน (สำคัญ)</label>
                                <input type="url" name="work_map_url" value="{{ old('work_map_url') }}"
                                    class="block w-full px-4 py-3 border-blue-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition duration-200"
                                    placeholder="วางลิงก์เช่น https://maps.app.goo.gl/...">
                            </div>

                            <div class="mb-4">
                                <label class="block text-xs font-semibold text-blue-700 mb-1">คำอธิบายจุดนัดหมาย (ถ้ามี)</label>
                                <textarea name="work_location_address" rows="2"
                                    class="block w-full px-4 py-3 border-blue-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition duration-200 resize-none"
                                    placeholder="เช่น ทางเข้าอยู่ข้างปั๊ม, จุดจอดรถหน้าฟาร์ม, แปลงนาหลังวัด">{{ old('work_location_address') }}</textarea>
                            </div>

                            <details class="bg-white/70 border border-blue-100 rounded-xl p-3">
                                <summary class="cursor-pointer text-xs font-bold text-blue-700">ตัวเลือกเพิ่มเติม: กรอกพิกัด LAT/LNG</summary>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                            <span class="text-gray-400 text-xs font-bold">LAT</span>
                                        </div>
                                        <input type="text" id="work_latitude" name="work_latitude"
                                            value="{{ old('work_latitude') }}"
                                            class="block w-full pl-11 pr-4 py-3 border-blue-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition duration-200"
                                            placeholder="เช่น 14.038481">
                                    </div>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                            <span class="text-gray-400 text-xs font-bold">LNG</span>
                                        </div>
                                        <input type="text" id="work_longitude" name="work_longitude"
                                            value="{{ old('work_longitude') }}"
                                            class="block w-full pl-11 pr-4 py-3 border-blue-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition duration-200"
                                            placeholder="เช่น 100.728956">
                                    </div>
                                </div>
                            </details>

                            <p class="text-xs text-blue-700/80 mt-2 ml-1"><i class="fa-solid fa-circle-info"></i> ลำดับการใช้งาน: ลิงก์หน้างาน > พิกัดหน้างาน > พิกัดลูกค้า > ที่อยู่ลูกค้า</p>
                        </div>
                ...
                {{-- ================= Action Buttons ================= --}}
                <div
                    class="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 bg-gray-50/50 -mx-8 -mb-10 p-8">
                    <a href="{{ route('admin.customers.index') }}"
