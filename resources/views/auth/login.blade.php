...
@section('content')
    <div class="w-full max-w-md mx-auto p-6">
        ...
        <form method="POST" action="{{ route('login.submit') }}" class="space-y-5">
            ...
            {{-- Username --}}
            <div>
                <label for="username" class="block text-sm font-bold text-gray-700 mb-1">ชื่อผู้ใช้</label>
                <div class="relative">
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username') }}" required autofocus
                        ...
                        placeholder="ระบุชื่อผู้ใช้ของคุณ" autocomplete="off">
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="remember"
                        class="w-4 h-4 text-agri-primary border-gray-300 rounded focus:ring-agri-primary">
